...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('market_manus_v3.log'),
...
class SimpleCapitalConfig:
    ...
    def __init__(self, initial_capital: float = 1000.0, position_size_pct: float = 2.0, 
                 compound_interest: bool = True, **kwargs):
...
def load_capital_manager():
    ...
    try:
        ...
        from capital_manager import CapitalManager, CapitalConfig
...
class MarketManusCliV3:
    ...
    def full_validation(self):
        ...
        for key, strategy in self.strategies.items():
            ...
            print(f"   {status} Sharpe: {results['sharpe_ratio']:.2f} | Return: {results['total_return']:.1%}")
