...
class TestRiskManagementAgent(AgentTestCase):
    ...
    def setUp(self):
        ...
        self.portfolio_data = {
            ...
            "positions": [
                {"symbol": "BTCUSDT", "size": 0.1, "entry_price": 45000, "current_price": 44500},
                {"symbol": "ETHUSDT", "size": 2.0, "entry_price": 3000, "current_price": 2950}
            ],
            "daily_pnl": -500.0,
            "max_drawdown": 0.08
        }
    ...
    def mock_calculate_position_size(self, account_balance, risk_per_trade, entry_price, stop_loss_price):
    ...
    def mock_calculate_stop_loss(self, entry_price, direction, atr_value=None, volatility=None):
    ...
    def mock_check_risk_limits(self, portfolio_data):
        ...
        current_drawdown = (portfolio_data["initial_balance"] - portfolio_data["current_balance"]) / portfolio_data["initial_balance"]
        ...
        daily_loss_percentage = abs(portfolio_data["daily_pnl"]) / portfolio_data["initial_balance"]
        if portfolio_data["daily_pnl"] < 0 and daily_loss_percentage > self.agent.risk_params["max_daily_loss"]:
            violations.append({
        ...
        total_position_value = sum(pos["size"] * pos["current_price"] for pos in portfolio_data["positions"])
    ...
    def mock_monitor_positions(self, positions):
        ...
        for position in positions:
            ...
            pnl_percentage = (position["current_price"] - position["entry_price"]) / position["entry_price"]
    ...
    def mock_calculate_portfolio_risk(self, portfolio_data, market_data=None):
        ...
        position_values = [pos["size"] * pos["current_price"] for pos in portfolio_data["positions"]]
    ...
    def test_stop_loss_with_atr(self):
        ...
        stop_loss_with_atr = self.agent.calculate_stop_loss(entry_price, direction, atr_value=atr_value)
    ...
    def test_drawdown_calculation(self):
        ...
        self.assertAlmostEqual(drawdown_info["max_drawdown"], (10500 - 9500) / 10500, places=4)
        self.assertAlmostEqual(drawdown_info["current_drawdown"], (10500 - 9700) / 10500, places=4)
    ...
    def test_risk_limits_checking(self):
        ...
        drawdown_violations = [v for v in violations if v["type"] == "max_drawdown_exceeded"]
    ...
    def test_risk_limits_with_safe_portfolio(self):
        ...
        safe_portfolio = {
            ...
            "positions": [
                {"symbol": "BTCUSDT", "size": 0.05, "entry_price": 45000, "current_price": 45500}
            ],
    ...
    def test_position_monitoring(self):
        ...
        positions = [
            {"symbol": "BTCUSDT", "size": 0.1, "entry_price": 45000, "current_price": 42000},  # Perda significativa
            {"symbol": "ETHUSDT", "size": 2.0, "entry_price": 3000, "current_price": 3100},    # Posição normal
            {"symbol": "ADAUSDT", "size": 10000, "entry_price": 0.5, "current_price": 0.52}    # Posição grande
        ]
    ...
    def test_extreme_market_conditions(self):
        ...
        extreme_portfolio = {
            ...
            "positions": [
                {"symbol": "BTCUSDT", "size": 0.2, "entry_price": 45000, "current_price": 30000}  # -33% na posição
            ],
    ...
    def test_position_sizing_edge_cases(self):
        ...
        high_risk = self.agent.calculate_position_size(10000, 0.5, 45000, 44000)  # 50% de risco
    ...
    def test_concurrent_risk_monitoring(self):
        ...
        large_portfolio = {
            ...
            "positions": [
                {"symbol": f"SYMBOL{i}", "size": 1.0, "entry_price": 1000 + i*10, "current_price": 950 + i*10}
    ...
    def test_risk_metrics_consistency(self):
        ...
        for i in range(1, len(results)):
            self.assertEqual(results[0]["portfolio_value"], results[i]["portfolio_value"])
            self.assertEqual(results[0]["position_count"], results[i]["position_count"])
            self.assertAlmostEqual(results[0]["risk_percentage"], results[i]["risk_percentage"], places=6)
...
class TestRiskManagementAgentIntegration(AgentTestCase):
    ...
    def test_full_risk_assessment_workflow(self):
        ...
        portfolio_data = {
            ...
            "positions": [
                {"symbol": "BTCUSDT", "size": 0.15, "entry_price": 45000, "current_price": 43000},
                {"symbol": "ETHUSDT", "size": 3.0, "entry_price": 3000, "current_price": 2800}
            ],
            "daily_pnl": -800.0,
            "max_drawdown": 0.08
        }
        ...
        self.assertGreater(total_alerts, 0)  # Deve haver alertas com este portfolio de risco
    ...
    def test_risk_management_under_stress(self):
        ...
        crash_portfolio = {
            ...
            "positions": [
                {"symbol": "BTCUSDT", "size": 1.0, "entry_price": 45000, "current_price": 25000},  # -44%
                {"symbol": "ETHUSDT", "size": 10.0, "entry_price": 3000, "current_price": 1500},   # -50%
                {"symbol": "ADAUSDT", "size": 50000, "entry_price": 0.8, "current_price": 0.3}     # -62%
            ],
        ...
        self.assertEqual(len(loss_alerts), 3)  # Todas as posições com perda significativa
